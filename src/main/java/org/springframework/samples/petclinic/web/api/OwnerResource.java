...
public class OwnerResource extends AbstractResourceController {
	...
	@RequestMapping(value = "/owner2/list", method = RequestMethod.GET)
	public Collection<Owner> findOwnerCollectionByCity(@RequestParam("city") String ownerCity) {

		if (ownerCity == null) {
			ownerCity = "";
		}

		return this.clinicService.findOwnerByCity(ownerCity);
	}
